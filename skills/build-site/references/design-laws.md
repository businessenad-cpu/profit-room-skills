# Design Laws (design the site to these)

GSAP + Lenis handle motion and scroll. These laws govern the design choices you make: palette, type, copy, and layout.
...
- Render long, ship as frames (see the scroll catalog for the frame-sequence recipe). Lock the camera to the scroll axis.
