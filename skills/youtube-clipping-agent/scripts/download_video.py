...
def download_video(url: str, output_dir: str = None) -> dict:
    ...
    ydl_opts = {
        ...
        # Use iOS player client to avoid 403s from YouTube SABR streaming restrictions
        ...
        # 下载字幕 - English only
        'writesubtitles': True,
        'writeautomaticsub': True,  # auto-captions as fallback
        'subtitleslangs': ['en'],   # English captions only
