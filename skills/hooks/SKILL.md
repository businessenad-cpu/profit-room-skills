...
## Personalization
This skill works in *your* brand voice, for *your* audience. Before running, load the brand profile at `~/.claude/brand-profile.md`.
- If it doesn't exist, run the **personalize** skill first (or just tell me your niche, audience, and offer — I'll create it).
- Use the profile's Audience and Main-pain to write hooks in the language your viewers would actually use to themselves, not generic marketing copy.
- If a field this skill needs is blank, I'll ask one quick question and save the answer back to the profile.
...
**Example triggers:**
- "Write hooks for my video on automating client reports"
- "Hook ideas for 'How I Got My First 10 Clients'"
...
- **Idea brief** — a positioning or ideation output
- **Outline** — the video's structure
...
|------------|-------------------------------|-------------------------------|
| Money | "Make more money" | "Automate the part of your work you hate" |
| Time | "Save 10 hours a week" | "Never start a project from a blank page again" |
| Status | "Become an expert" | "Build what your peers think takes a whole team" |
| Health | "Reduce work stress" | "Stop manually doing what a tool handles in seconds" |

### Phase 2 — Generate Hooks Using Five Desire-Based Variations

Generate at least one hook in EACH variation (fill the brackets with the user's real topic):
...
1. **Subject** — who the video is about (I, we, you, [the person])
...
- **Curiosity without clickbait.** The hook must promise something the video delivers. An audience bounces permanently on oversell.
